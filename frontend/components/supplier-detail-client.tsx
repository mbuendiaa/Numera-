  ...
  return (
    <div className="space-y-7">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard title="Última factura" value={analytics.latest_invoice_date ? date.format(new Date(`${analytics.latest_invoice_date}T00:00:00`)) : "—"} change={analytics.latest_purchase_price ? `último precio ${money.format(analytics.latest_purchase_price)}` : "sin precios"} icon={CalendarDays} />
      </div>
